...
export const columns: ColumnDef<CapitalClanRanking>[] = [
  {
    accessorKey: 'rank',
    header: ({ column }) => (
      <Button
    ...
    cell: ({ row }) => (
      <div className="flex items-center justify-center gap-2 w-full text-center">
        <Image
          ...
          width={20}
          height={20}
          src="https://static.wikia.nocookie.net/clashofclans/images/a/a0/GoldC.png/revision/latest?cb=20220502131424"
        />
        <p className={`${ibm.className} font-semibold text-right`}>
          {row.original.clanCapitalPoints}
        </p>
      </div>
    ),
  },
