...
export const columns: ColumnDef<TownHallClanRanking>[] = [
  {
    accessorKey: 'rank',
    header: ({ column }) => (
      <Button
    ...
    cell: ({ row }) => (
      <div className="flex items-center justify-center gap-2 w-full text-center">
        <Image
          ...
          width={20}
          height={20}
          src="https://static.wikia.nocookie.net/clashofclans/images/f/ff/ClanXP.png/revision/latest?cb=20171016174727"
        />
        <p className={`${ibm.className} font-semibold text-right`}>
          {row.original.clanPoints}
        </p>
      </div>
    ),
  },
